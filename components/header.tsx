      ...
      <div className="flex items-center gap-2">
        <Link href="/" className="flex items-center gap-2">
          <div className="grid grid-cols-2 grid-rows-2 rounded-sm overflow-hidden">
            <Heart size={16} strokeWidth={3} className="text-red-100 bg-red-800 p-[1px]" />
            <Spade size={16} strokeWidth={3} className="text-slate-100 bg-slate-800 p-[1px]" />
            <Diamond size={16} strokeWidth={3} className="text-blue-100 bg-blue-800 p-[1px]" />
            <Club size={16} strokeWidth={3} className="text-green-100 bg-green-800 p-[1px]" />
          </div>
          <h1
